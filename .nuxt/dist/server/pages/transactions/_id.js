...
module.exports.__inject__ = function (context) {
  add("26081cae", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TransactionDetail_vue_vue_type_style_index_0_id_f76070f8_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(242);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TransactionDetail_vue_vue_type_style_index_0_id_f76070f8_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TransactionDetail_vue_vue_type_style_index_0_id_f76070f8_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TransactionDetail_vue_vue_type_style_index_0_id_f76070f8_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_TransactionDetail_vue_vue_type_style_index_0_id_f76070f8_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".bg-primary-lighten[data-v-f76070f8]{background-color:#fce9ec!important}.text-primary-lighten[data-v-f76070f8]{color:#fce9ec}.bg-body[data-v-f76070f8]{background-color:#f6f9fc}.footer-text[data-v-f76070f8]{color:#bdbdbd}.border-primary[data-v-f76070f8]{border:1px solid #279ad6!important}.bg-white[data-v-f76070f8]{background-color:#fff}a[data-v-f76070f8]{color:#279ad6!important}h1[data-v-f76070f8]{font-size:30px}h2[data-v-f76070f8]{font-size:25px}h3[data-v-f76070f8]{font-size:20px}h4[data-v-f76070f8]{font-size:17px}.text-14[data-v-f76070f8],h5[data-v-f76070f8]{font-size:14px}.text-16[data-v-f76070f8]{font-size:16px}.text-sm[data-v-f76070f8]{font-size:12px}.text-11[data-v-f76070f8]{font-size:11px!important}.text-10[data-v-f76070f8]{font-size:10px}.text-30[data-v-f76070f8]{font-size:30px}.text-40[data-v-f76070f8]{font-size:40px}.text-tiny[data-v-f76070f8]{font-size:10px}.display-1[data-v-f76070f8]{font-size:80px}.show-2[data-v-f76070f8]{font-size:66px}@media(max-width:992px){.show-2[data-v-f76070f8]{font-size:15px!important}}.show-3[data-v-f76070f8]{line-height:1.2;font-size:50px!important}@media(max-width:600px){.show-3[data-v-f76070f8]{font-size:30px!important}}@media(max-width:400px){.show-3[data-v-f76070f8]{font-size:15px!important}}@media(max-width:992px){.banner-text[data-v-f76070f8]{font-size:12px!important}}.shadow-sm[data-v-f76070f8]{box-shadow:0 1px 3px rgba(3,0,71,.09)!important}.shadow[data-v-f76070f8]{box-shadow:0 4px 16px rgba(43,52,69,.1)!important}.shadow-lg[data-v-f76070f8]{box-shadow:0 8px 45px rgba(3,0,71,.09)!important}.font-600[data-v-f76070f8]{font-weight:600}.ls-4[data-v-f76070f8]{letter-spacing:4px}.leading-tight[data-v-f76070f8]{line-height:1.25}.container-lg[data-v-f76070f8]{max-width:1200px}.flex-1[data-v-f76070f8]{flex:1}.cursor-pointer[data-v-f76070f8]{cursor:pointer}.w-33[data-v-f76070f8]{width:33.33%}.border-grey[data-v-f76070f8]{border:1px solid #dae1e7}.z-0[data-v-f76070f8]{z-index:0}.z-1[data-v-f76070f8]{z-index:1}.z-10[data-v-f76070f8]{z-index:10}.br-8[data-v-f76070f8]{border-radius:8px!important}.br-12[data-v-f76070f8]{border-radius:12px!important}.h-100[data-v-f76070f8]{height:100%}.border-4-white[data-v-f76070f8]{border:4px solid #fff}.card-overlay-item[data-v-f76070f8]{position:relative}.card-overlay-item[data-v-f76070f8]:after{content:\"\";position:absolute;top:0;left:0;width:100%;height:100%;transition:all .25s ease-in-out 0s}.card-overlay-item[data-v-f76070f8]:hover:after{background:rgba(0,0,0,.3);z-index:0;border-radius:8px;cursor:pointer}.top-search-bar .v-text-field__details[data-v-f76070f8]{display:none!important}svg[data-v-f76070f8]{fill:currentColor!important}svg.icon[data-v-f76070f8]:focus,svg[data-v-f76070f8]:focus{outline:none}.bb-primary[data-v-f76070f8]{border-bottom:2px solid #279ad6}ul.navbar-nav li.nav-item[data-v-f76070f8]{position:relative;z-index:10}ul.navbar-nav li.nav-item:hover ul[data-v-f76070f8]{display:block}ul.navbar-nav li.nav-item>ul[data-v-f76070f8]{position:absolute}ul.navbar-nav li.nav-item ul[data-v-f76070f8]{top:100%;box-shadow:0 4px 16px rgba(43,52,69,.1);background-color:#fff;padding:5px 0;width:250px;max-width:250px;border-radius:8px;display:none}ul.navbar-nav li.nav-item ul li[data-v-f76070f8]{position:relative;list-style-type:none}ul.navbar-nav li.nav-item ul li[data-v-f76070f8]:hover{background-color:#f6f9fc}ul.navbar-nav li.nav-item ul li a[data-v-f76070f8]{width:100%;color:#4b566b;padding:.5rem 1rem;display:flex}ul.navbar-nav li.nav-item ul li:hover .navbar-submenu[data-v-f76070f8]{display:block}ul.navbar-nav li.nav-item ul li .navbar-submenu[data-v-f76070f8]{position:absolute;left:100%;top:0;display:none;width:100%;z-index:10;padding-left:1rem}ul.navigation-navbar .nav-item .nav-link[data-v-f76070f8]{color:#0f3460}ul.navigation-navbar .nav-item .nav-link.active[data-v-f76070f8],ul.navigation-navbar .nav-item .nav-link[data-v-f76070f8]:hover{color:#279ad6}.hero-section-bg ul.navigation-navbar .nav-item .nav-link[data-v-f76070f8]{color:#fff}.hero-section-bg ul.navigation-navbar .nav-item .nav-link.active[data-v-f76070f8],.hero-section-bg ul.navigation-navbar .nav-item .nav-link[data-v-f76070f8]:hover{color:#279ad6}ul.navbar-nav li.nav-item[data-v-f76070f8]{list-style:none;margin-right:2rem!important}ul.navbar-nav li.nav-item[data-v-f76070f8]:last-child{margin-right:0!important}ul.navbar-nav li.nav-item a[data-v-f76070f8]{text-decoration:none}.router-link-active[data-v-f76070f8]{color:#279ad6}.vuetify-carousel .v-carousel__controls .v-item-group button[data-v-f76070f8]{color:#0f3460}.slick-next.slick-disabled[data-v-f76070f8]:before,.slick-prev.slick-disabled[data-v-f76070f8]:before{opacity:.5!important}.slick-next.slick-top-next-btn[data-v-f76070f8]{top:-40px;right:0}.slick-next[data-v-f76070f8]:before{opacity:0!important}@media(max-width:992px){.slick-next[data-v-f76070f8]{right:5px!important}}.slick-prev[data-v-f76070f8]{position:absolute;z-index:2}.slick-prev.slick-top-prev-btn[data-v-f76070f8]{top:-40px;left:calc(100% - 105px)}@media(max-width:992px){.slick-prev.slick-top-prev-btn[data-v-f76070f8]{left:calc(100% - 105px)!important}}.slick-prev[data-v-f76070f8]:before{opacity:0!important}@media(max-width:992px){.slick-prev[data-v-f76070f8]{left:5px!important}}.slick-dots[data-v-f76070f8]{bottom:0!important}.slick-dots li button[data-v-f76070f8]:before{font-size:16px!important}.slick-dots li.slick-active button[data-v-f76070f8]:before,.slick-dots li:hover button[data-v-f76070f8]:before{color:#0f3460!important;opacity:1!important}@media(max-width:375px){.slick-header-top-title[data-v-f76070f8]{width:200px}}.slick-left-arrow[data-v-f76070f8]{position:absolute;left:0!important}.slick-right-arrow[data-v-f76070f8]{position:absolute;right:0!important}.slick-button-hover:hover .slick-arrow[data-v-f76070f8]{display:block}.slick-button-hover .slick-arrow[data-v-f76070f8]{display:none}.icon[data-v-f76070f8]{width:24px;height:24px}.avatar-64[data-v-f76070f8]{width:64px;height:auto}.brand-tabs .v-tabs-slider-wrapper[data-v-f76070f8]{display:none}.box-wrapper[data-v-f76070f8]{position:relative;display:flex;align-items:flex-start;width:100%;border-radius:8px}@media(max-width:959px){.box-wrapper .box-overlay[data-v-f76070f8]{position:fixed;top:0;left:0;width:100%;height:100%;z-index:99;background-color:rgba(0,0,0,.5);display:none}.box-wrapper .box-overlay.open[data-v-f76070f8]{display:block}}.box-wrapper.box-wrapper-version-2 .box-sidebar[data-v-f76070f8]{border-radius:0}.box-wrapper .box-sidebar[data-v-f76070f8]{width:282px;background-color:#fff;border-radius:8px;transition:all .3s ease}@media(max-width:959px){.box-wrapper .box-sidebar[data-v-f76070f8]{position:fixed;top:0;left:-282px;border-radius:0;z-index:99;overflow-y:scroll;height:calc(100% - 56px)}.box-wrapper .box-sidebar.open[data-v-f76070f8]{left:0}}.box-wrapper .box-content[data-v-f76070f8]{width:calc(100% - 300px);margin-left:auto;border-radius:8px}@media(max-width:959px){.box-wrapper .box-content[data-v-f76070f8]{width:100%}}.custom-form-wizard.vue-form-wizard.md .wizard-icon-circle[data-v-f76070f8]{width:96px!important;height:36px!important}.custom-form-wizard.vue-form-wizard.md .wizard-navigation .wizard-progress-with-circle[data-v-f76070f8]{top:23px!important}.custom-form-wizard.vue-form-wizard .wizard-icon-circle.square_shape[data-v-f76070f8],.custom-form-wizard.vue-form-wizard .wizard-icon-circle .wizard-icon-container.square_shape[data-v-f76070f8],.custom-form-wizard .vue-form-wizard .wizard-icon-circle .wizard-icon-container.tab_shape[data-v-f76070f8]{border-radius:20px!important}.custom-form-wizard.vue-form-wizard .wizard-icon-circle[data-v-f76070f8]{border:none!important;border-radius:50%;font-weight:600;background-color:#ffe1e6!important;position:relative}.custom-form-wizard.vue-form-wizard .wizard-icon-circle.checked[data-v-f76070f8]{background-color:#279ad6!important}.custom-form-wizard.vue-form-wizard .wizard-icon-circle.checked i[data-v-f76070f8]{color:#fff!important}.custom-form-wizard.vue-form-wizard.md .wizard-navigation .wizard-progress-with-circle[data-v-f76070f8]{background-color:#ffe1e6}.custom-form-wizard i.wizard-icon[data-v-f76070f8]{font-size:20px;color:#279ad6}.custom-form-wizard .stepTitle[data-v-f76070f8]{color:#279ad6}.input-group-btn[data-v-f76070f8]{display:flex;align-items:center}.input-group-btn .v-input__slot[data-v-f76070f8]{border-top-right-radius:0;border-bottom-right-radius:0;border-right:none}.input-group-btn button[data-v-f76070f8]{border-top-left-radius:0;border-bottom-left-radius:0;height:42px!important}.p-relative[data-v-f76070f8]{position:relative!important}.p-absolute[data-v-f76070f8]{position:absolute!important}.right-0[data-v-f76070f8]{right:0}.top-0[data-v-f76070f8]{top:0}.bottom-0[data-v-f76070f8]{bottom:0}v-application a[data-v-f76070f8]{color:#279ad6!important}.mb-60[data-v-f76070f8]{margin-bottom:60px}.py-48[data-v-f76070f8]{padding-top:48px;padding-bottom:48px}.mt-32[data-v-f76070f8]{margin-top:32px}.mt--66[data-v-f76070f8]{margin-top:-66px}.mw-0[data-v-f76070f8]{min-width:0}.w-100[data-v-f76070f8]{width:100%}.size-28[data-v-f76070f8]{width:28px;height:28px}.min-vh-100[data-v-f76070f8]{min-height:100vh}.w-200[data-v-f76070f8]{width:200px}.mw-70[data-v-f76070f8]{max-width:70px}*[data-v-f76070f8]{font-size:14px}body[data-v-f76070f8],html[data-v-f76070f8]{color:#2b3445;background-color:#fff}.product-slider .product-slider-click[data-v-f76070f8]{display:flex;justify-content:center}.product-slider .product-slider-click[data-v-f76070f8] .slick-slide{width:80px!important;margin-right:16px;border:1px solid #dae1e7;border-radius:5px}.product-slider .product-slider-click[data-v-f76070f8] .slick-current{border:1px solid #d23f57;border-radius:5px}.card-bg[data-v-f76070f8]{background:linear-gradient(89deg,#154abd .1%,#1a8ad3 51.5%,#48b1ea 100.2%);color:#fff}.v-list-item[data-v-f76070f8]{align-items:center;display:flex;flex:1 1 100%;letter-spacing:normal;min-height:48px;outline:none;padding:0 16px;position:relative;text-decoration:none}.v-list-item[data-v-f76070f8],.v-list-item__subtitle[data-v-f76070f8]{color:#fff!important}.space-between[data-v-f76070f8]{display:flex;justify-content:space-between;border-bottom:1px solid;padding:5px}.content-align[data-v-f76070f8]{width:70%;margin-left:auto;margin-right:auto}.text-align[data-v-f76070f8]{display:flex;grid-gap:5px;gap:5px}.slick-list[data-v-f76070f8]{max-height:500px!important}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/transaction/TransactionDetail.vue?vue&type=template&id=f76070f8&scoped=true&
...
var TransactionDetailvue_type_template_id_f76070f8_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
// CONCATENATED MODULE: ./components/transaction/TransactionDetail.vue?vue&type=template&id=f76070f8&scoped=true&
  ...
  head() {
    return {
      ...
      // Twitter meta settings
      {
        ...
        name: 'twitter:title',
        hid: 'twitter:title',
        content: this.tool.title
      }, {
        name: 'twitter:description',
        hid: 'twitter:desccription',
        content: this.description
      }]
    };
  },
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  TransactionDetailvue_type_template_id_f76070f8_scoped_true_render,
  staticRenderFns,
  false,
  injectStyles,
  "f76070f8",
