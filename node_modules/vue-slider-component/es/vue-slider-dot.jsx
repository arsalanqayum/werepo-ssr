...
let VueSliderDot = /** @class */ (() => {
    let VueSliderDot = class VueSliderDot extends Vue {
        ...
        render() {
            return (<div ref="dot" class={this.dotClasses} aria-valuetext={this.tooltipValue ? this.tooltipValue.toString() : ''} onMousedown={this.dragStart} onTouchstart={this.dragStart}>
